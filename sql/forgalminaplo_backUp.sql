...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2022. Már 09. 19:45
...
INSERT INTO `diak` (`ID`, `felhNev`, `jelszo`, `telSzam`, `email`, `status`, `jog`, `tanarID`) VALUES
(2, 'teszt1diak', 'cdfac85df641c02fd0e491df0a97ea456fe4e945', '0632222222', 'teszt1diak@teszt.hu', 1, 1, 1);
...
INSERT INTO `tanar` (`ID`, `felhNev`, `jelszo`, `telSzam`, `email`, `status`, `jog`, `iskolaID`, `orastatus`) VALUES
